    ...
    <div class="card shadow-sm">
        <div class="card-body">
            ...
            <div class="d-flex justify-content-between align-items-start flex-wrap mb-3 gap-2">
                ...
                <div class="d-flex flex-column gap-2" style="max-width: 100%; min-width: 335px;">
                    <!-- Form Pencarian -->
                    <form method="GET" action="{{ route('mustahik.index') }}" class="d-flex">
        ...
        <div class="d-flex justify-content-between align-items-center mt-3 flex-wrap px-2">
            ...
            <div class="d-flex align-items-center">
                <div class="badge bg-success text-white rounded-pill px-3 py-2 fw-normal">
                    ...
                    {{-- Next button --}}
                    @if ($mustahik->currentPage() == $mustahik->lastPage())
                    <span class="btn-sm text-white opacity-50">
